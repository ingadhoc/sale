...
class SaleOrder(models.Model):
    ...
    @api.depends("picking_ids", "picking_ids.state", "force_delivery_status", "order_line.qty_delivered", "order_line.product_uom_qty")
    def _compute_delivery_status(self):
        ...
        for order in self:
            ...
            storable_lines = order.order_line.filtered(lambda l: l.product_id.type == 'consu' and l.product_id.is_storable)
            ...
            service_status = "full" if service_fully_delivered else ("partial" if service_partially_delivered else "pending")
            ...
            elif storable_status == "partial" or service_status == "partial":
